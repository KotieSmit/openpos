...
class TouchSales extends Secure_area
{
	function __construct()
	{
		parent::__construct('touchSales');
	...
	function complete()
	{
		...
		else
		{
			if ($this->sale_lib->get_email_receipt() && !empty($cust_info->email))
			{
				...
				$this->email->message($this->load->view("touchSales/receipt_email",$data, true));	
				$this->email->send();
			}
		}
		$this->load->view("touchSales/receipt",$data);
	...
	function edit($sale_id)
	{
		...
		$this->load->view('touchSales/edit', $data);
	}
	...
	function delete($sale_id)
	{
		...
		$this->load->view('touchSales/delete', $data);
	...
	function _reload($data=array())
	{
		...
		$this->load->view("touchSales/register",$data);
	}
	...
	function suspended()
	{
		...
		$this->load->view('touchSales/suspended', $data);
	}
