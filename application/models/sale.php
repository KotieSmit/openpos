...
class Sale extends CI_Model
{
	...
	public function create_sales_items_temp_table()
	{
		...
		(item_unit_price*quantity_purchased-item_unit_price*quantity_purchased*discount_percent/100) - ROUND((item_unit_price*quantity_purchased-item_unit_price*quantity_purchased*discount_percent/100)/(1+(SUM(percent)/100)),2) as tax,
		ROUND((item_unit_price*quantity_purchased-item_unit_price*quantity_purchased*discount_percent/100)/(1+(SUM(percent)/100)),2)  - (item_cost_price*quantity_purchased) as profit
