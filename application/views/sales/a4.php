...
<!--	    <td colspan="2" align="center">--><?php //echo $item['description']; ?><!--</td>-->
	...
	<td colspan="1" style='text-align:right'><?php echo to_currency($total); ?></td>
		...
		<td colspan="5" style="text-align:right;"><?php $splitpayment=explode(':',$payment['payment_type']); echo $splitpayment[0]; ?> </td>
		<td colspan="1" style="text-align:right"><?php echo to_currency( $payment['payment_amount'] * -1 ); ?>  </td>
            </tr>
        <?php
        }
        ?>
